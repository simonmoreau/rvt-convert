...
namespace api
{
  public class GetForgeToken
  {
    ...
    public GetForgeToken(TwoLeggedApi twoLeggedApi)
    {
      this._twoLeggedApi = twoLeggedApi;
    }

    [FunctionName("GetForgeToken")]
    public async Task<IActionResult> Run(
    [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "getforgetoken")] HttpRequest req,
