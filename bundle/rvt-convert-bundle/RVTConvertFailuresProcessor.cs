...
namespace RVTConvertBundle
{
  ...
  class RVTConvertFailuresProcessor
  {
    ...
    {
      RVTConvertBundleApp.LogTrace("Enter FailureProcessor event.");
    ...
    {
      RVTConvertBundleApp.LogTrace("Enter ProcessFailure function - Ligne 30.");
      ...
      foreach (FailureMessageAccessor failureMessageAccessor in failureMessagesList)
      {
        ...
        RVTConvertBundleApp.LogTrace("Default Resolution Caption: " + failureMessageAccessor.GetDefaultResolutionCaption());
        ...
        {
          RVTConvertBundleApp.LogTrace("Failure: Attempted to resolve the failure "
