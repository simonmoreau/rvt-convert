...
import {
  IForgeToken, IWorkItemResponse, IWorkItemStatus, IMessage, ICheckoutSessionId,
  IConversionCreditsUpdate, IWorkItemStatusEntity
} from './api.model';
...
export class ApiService {
  ...
  public getForgeToken(): Observable<IForgeToken> {
    return this.get<IForgeToken>(this.baseAPIURL + 'getforgetoken');
  }
